...
const CoursListPage = ({ params, onButtonClick }) => {
  ...
  const fetchCours = async () => {
    try {
      ...
      const response = await axios.get(
        `http://127.0.0.1:8000/api/enseignement/${params}`,
        {
          headers: {
          ...
          <div className="bg-green-200 md:flex rounded-lg mb-4  md:p-3">
            ...
            <div className="p-6 ">
              ...
              <p className="text-gray-600 mt-2">
                Découvrez tous les cours disponibles pour votre classe {params}
              </p>
            </div>
          </div>
                      ...
                      >
                        <Card.Body>
                          ...
                          <Button
                            ...
                            onClick={() => onButtonClick(setParam(item.id))}
                          >
                            Voir détails
                          </Button>
                        </Card.Body>
